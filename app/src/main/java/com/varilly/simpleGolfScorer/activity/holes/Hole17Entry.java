...
public class Hole17Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole17_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(16).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(16).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(16).getStrokeIndex());
        intent.putExtras(b);
