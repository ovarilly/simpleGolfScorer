...
public class Hole6Entry extends AbstractHoleEntry  {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole6_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(5).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(5).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(5).getStrokeIndex());
        intent.putExtras(b);
