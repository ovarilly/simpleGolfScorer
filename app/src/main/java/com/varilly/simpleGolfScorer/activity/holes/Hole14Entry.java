...
public class Hole14Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole14_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(13).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(13).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(13).getStrokeIndex());
        intent.putExtras(b);
