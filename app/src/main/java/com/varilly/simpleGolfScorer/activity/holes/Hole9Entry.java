...
public class Hole9Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole9_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(8).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(8).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(8).getStrokeIndex());
        intent.putExtras(b);
