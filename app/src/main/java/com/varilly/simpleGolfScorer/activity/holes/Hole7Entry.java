...
public class Hole7Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole7_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(6).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(6).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(6).getStrokeIndex());
        intent.putExtras(b);
