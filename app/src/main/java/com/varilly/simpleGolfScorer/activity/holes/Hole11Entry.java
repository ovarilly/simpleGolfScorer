...
public class Hole11Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole11_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(10).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(10).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(10).getStrokeIndex());
        intent.putExtras(b);
