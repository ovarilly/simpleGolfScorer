...
public class Hole3Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole3_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(2).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(2).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(2).getStrokeIndex());
        intent.putExtras(b);
