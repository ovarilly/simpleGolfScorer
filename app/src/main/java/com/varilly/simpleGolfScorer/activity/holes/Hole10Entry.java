...
public class Hole10Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole10_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(9).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(9).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(9).getStrokeIndex());
        intent.putExtras(b);
