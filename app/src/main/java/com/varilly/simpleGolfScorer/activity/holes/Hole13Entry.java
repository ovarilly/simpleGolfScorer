...
public class Hole13Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole13_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(12).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(12).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(12).getStrokeIndex());
        intent.putExtras(b);
