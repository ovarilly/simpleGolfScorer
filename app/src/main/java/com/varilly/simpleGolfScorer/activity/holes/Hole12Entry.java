...
public class Hole12Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole12_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(11).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(11).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(11).getStrokeIndex());
        intent.putExtras(b);
