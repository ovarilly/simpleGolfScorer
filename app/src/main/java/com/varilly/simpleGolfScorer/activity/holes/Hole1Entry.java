...
public class Hole1Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole1_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(0).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(0).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(0).getStrokeIndex());
        intent.putExtras(b);
