...
public class Hole8Entry extends AbstractHoleEntry {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole8_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(7).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(7).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(7).getStrokeIndex());
        intent.putExtras(b);
