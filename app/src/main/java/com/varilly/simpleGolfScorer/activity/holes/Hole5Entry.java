...
public class Hole5Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole5_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(4).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(4).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(4).getStrokeIndex());
        intent.putExtras(b);
