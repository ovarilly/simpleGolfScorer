...
public class Hole4Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole4_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(3).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(3).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(3).getStrokeIndex());
        intent.putExtras(b);
