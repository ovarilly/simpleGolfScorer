...
public class Hole18Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole18_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(17).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(17).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(17).getStrokeIndex());
        intent.putExtras(b);
