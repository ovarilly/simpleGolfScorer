...
public class Hole15Entry extends AbstractHoleEntry {
...
private ScoreboardListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hole15_entry_activity);
    ...
    public void goToScoreEntry(View view){
        ...
        b.putInt(HOLE_NUMBER, holeListAdapter.getCurrentList().get(14).getHoleNumber());
        b.putInt(HOLE_PAR, holeListAdapter.getCurrentList().get(14).getPar());
        b.putInt(HOLE_SI, holeListAdapter.getCurrentList().get(14).getStrokeIndex());
        intent.putExtras(b);
